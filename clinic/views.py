...
def AssetLink(request):
    assetlink = [
    {
        ...
        "package_name": "xyz.appmaker.pevzov",
        "sha256_cert_fingerprints": ["33:0A:7E:54:7D:7E:67:B4:0A:AC:B8:7D:FB:5B:45:AD:E3:B7:1D:C0:79:6D:C0:05:EA:0C:2F:C7:75:4B:33:BA"]
        }
    }
    ]
